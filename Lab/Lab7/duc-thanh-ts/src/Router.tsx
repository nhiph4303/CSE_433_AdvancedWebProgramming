...
import ProtectedAdminRoute from "./GUI/Components/Admin/ProtectedAdminRoute";
...
const ProductCategoryPage = lazy(
  () => import("./GUI/Pages/User/ProductCategoryPage"),
);
const ProductDetailPage = lazy(
  () => import("./GUI/Pages/User/ProductDetailPage"),
);
const NewsCategoryPage = lazy(
  () => import("./GUI/Pages/User/NewsCategoryPage"),
);
...
const AdminLogin = lazy(() => import("./GUI/Pages/Auth/AdminLogin"));

// ─── Admin Pages ──────────────────────────────────────────────────────────────
const AdminDashboard = lazy(() => import("./GUI/Pages/Admin/AdminDashboard"));
const ProductCategoryManagement = lazy(
  () => import("./GUI/Pages/Admin/ProductCategoryManagement"),
);
const ProductManagement = lazy(
  () => import("./GUI/Pages/Admin/ProductManagement"),
);
...
export const router = createBrowserRouter([
  // ── User layout ──────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      // Trang đăng nhập / đăng ký cho USER (nằm trong UserLayout)
      {
        path: "signin",
        element: (
          <Suspense fallback={<PageLoader />}>
  ...
  // ── Admin login (standalone, KHÔNG có AdminLayout hay ProtectedAdminRoute) ─
  {
    path: "/admin/login",
    element: (
      <Suspense fallback={<PageLoader />}>
  ...
  // ── Admin layout (được bảo vệ bởi ProtectedAdminRoute) ───────────────────
  {
    path: "/admin",
    element: (
      <ProtectedAdminRoute>
