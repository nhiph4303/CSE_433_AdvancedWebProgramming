          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 col-md-3">
                <form
                  action="http://10.10.128.155/ducthanhcomputer"
                  method="GET"
                >
              ...
              <div className="col-12 col-md-4 righ-logo-groups">
                ...
                <div>
                  <i className="fa fa-clock-o"></i> Mở cửa từ 8h - 19h các ngày
                  trong tuần
                </div>
              </div>
            </div>
              ...
              <div className="d-none d-md-block col-md-8 offset-md-4">
                <div className="left-menu">
                  <ul id="menu-top-menu" className="left-menu">
                    ...
                    >
                      <a href="http://10.10.128.155/ducthanhcomputer/gioi-thieu/">
                        Giới thiệu
                      </a>
                    </li>
                    <li
                    ...
                    >
                      <a href="http://10.10.128.155/ducthanhcomputer/bao-hanh/">
                        Bảo hành
                      </a>
                    </li>
                    <li
                    ...
                    >
                      <a href="http://10.10.128.155/ducthanhcomputer/lien-he/">
                        Liên hệ
                      </a>
                    </li>
                  </ul>
            ...
            <div className="col-12 col-md-4 menu-position">
              ...
              <div className="menu-groups">
                <ul id="menu-main-menu" className="main-menu">
                  <li
                    id="menu-item-31"
                    className="menu-item menu-item-type-taxonomy menu-item-object-category current-menu-item menu-item-has-children menu-item-31"
                  >
                    <a
                      href="http://10.10.128.155/ducthanhcomputer/category/laptop/"
                      aria-current="page"
                    >
                      Laptop
                    </a>
                  ...
                  >
                    <a href="http://10.10.128.155/ducthanhcomputer/category/may-bo/">
                      Máy bộ
                    </a>
                    <ul className="sub-menu">
                      <li
                  ...
                  >
                    <a href="http://10.10.128.155/ducthanhcomputer/category/man-hinh/">
                      Màn hình
                    </a>
                    <ul className="sub-menu">
                      <li
                  ...
                  >
                    <a href="http://10.10.128.155/ducthanhcomputer/category/gears/">
                      GEARS
                    </a>
                  </li>
                  <li
                  ...
                  >
                    <a href="http://10.10.128.155/ducthanhcomputer/category/camera/">
                      Camera
                    </a>
                  </li>
                </ul>
